    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="text-center">
                <a class="btn btn-sm btn-primary" href="{{ route('assuntos.editar', ['id' => $assunto->id]) }}">Editar</a>
                <form action="{{ route('assuntos.excluir', ['id' => $assunto['id']]) }}" method="POST" style="display: inline-block;">
                    @csrf
                    @method('DELETE')
